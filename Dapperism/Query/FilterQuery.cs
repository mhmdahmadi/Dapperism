...
namespace Dapperism.Query
{
    public class FilterQuery
    {
        ...
        public FilterQuery TableOrView(string name)
        {
            _create = true;
            TableName = name;
            return this;
        ...
        public FilterQuery AggregateByOr
        {
            get
            {
        ...
        public FilterQuery AddFilter(string columnName, FilterOperation filterOperation, object value)
        {
