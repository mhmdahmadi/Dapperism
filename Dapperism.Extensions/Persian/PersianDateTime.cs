...
namespace Dapperism.Extensions.Persian
{
    ...
    public class PersianDateTime
    {
        ...
        private static readonly string[] DayNames = { "شنبه", "یکشنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنج شنبه", "جمعه" };
        ...
        public int Year
        {
            get { return PersianCalendar.GetYear(_dateTime); }
        }
        ...
        public int Month
        {
            get { return PersianCalendar.GetMonth(_dateTime); }
        }
        ...
        public int Day
        {
            get { return PersianCalendar.GetDayOfMonth(_dateTime); }
        }
        ...
        {
            return PersianCalendar.GetWeekOfYear(_dateTime, rule, System.DayOfWeek.Saturday);
        }
        ...
        {
            get { return PersianCalendar.GetDayOfYear(_dateTime); }
        }
